...
# 📖 [Diagram_based_database] <a name="about-project"></a>

- The goal of this project is to create a database based on the schema_diagram bellow.

  > ![schema_diagram](https://github.com/microverseinc/curriculum-databases/blob/main/db-structure/images/clinic_diagram.png)
...
```sh
 git clone https://github.com/diagram-based-database.git
```

- Navigate to cloned repo:
```sh
 cd diagram-based-database
```
